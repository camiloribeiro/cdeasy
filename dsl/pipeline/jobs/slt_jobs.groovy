...
JobHelper.addDeliveryPipelineConfiguration(slt_1, 'api test', 'service level test 1')

Job slt_2 = JobHelper.createJob(this as DslFactory, "service_level_test_2")
JobHelper.addStep(slt_2, "sleep \$((RANDOM%10+5))")
JobHelper.addDeliveryPipelineConfiguration(slt_2, 'api test', 'service level test 2')
