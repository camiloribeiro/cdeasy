...
Job running_erlang = JobHelper.createJob(this as DslFactory, "Running Erlang")
...
Job running_java = JobHelper.createJob(this as DslFactory, "Running Java")
...
Job running_ruby = JobHelper.createJob(this as DslFactory, "Running Ruby")
...
Job running_node = JobHelper.createJob(this as DslFactory, "Running Node")
...
Job running_python = JobHelper.createJob(this as DslFactory, "Running Python")
...
Job running_compose = JobHelper.createJob(this as DslFactory, "Running Docker Compose")
